...
## Algorithm
Start the program. Read two integers. Create an adjacency list g of size n. Repeat e times. Read the source node. Initialize a boolean array of size n, all set to false. Create an empty queue. Mark src as visited and enqueue it. Continue until all reachable nodes are processed. Stop the program. 
...
<img width="515" height="353" alt="image" src="https://github.com/user-attachments/assets/a2c3c67b-af35-4623-ac61-21e47da97fe3" />
