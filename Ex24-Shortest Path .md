...
## Algorithm
Start the program. Read integers. Create an adjacency list graph of size n. Build the Graph. Read Start and Target. Initialize BFS. Initialize DFS Counting Reachable Attractions and Print. End the program.
...
<img width="812" height="248" alt="image" src="https://github.com/user-attachments/assets/e3d7f247-dfc8-4b3d-b19d-ff138e61b1a4" />
