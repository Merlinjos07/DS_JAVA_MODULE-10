...
## Algorithm
Start the program. Read integer. Create an array of size n. Read n integers and store them in array. Building the Tree (Level-Order). Counting Left Subtree Nodes. Print the result. Stop the program.
...
<img width="538" height="350" alt="image" src="https://github.com/user-attachments/assets/33a53f94-9516-4ccb-9746-7accbb742e6f" />
