...
## Algorithm
Start the program. Read integers. Create an adjacency list graph of size n, where each node stores a list of (neighbor, time) pairs. Build the Graph. Read Remaining Input. Initialize Dijkstra’s setup. Dijkstra’s Relaxation Loop. Find minimum time among stations. End the program  
...
<img width="550" height="447" alt="image" src="https://github.com/user-attachments/assets/4ffe079d-1532-42cd-a533-ab9ebc8f9b79" />
